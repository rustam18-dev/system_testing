                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">Создание типов теста</h5>
                            <small class="text-muted float-end">Добавление типов теста</small>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="/testType">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="basic-default-name" placeholder="Название типа" name="name" />
                                    </div>
                                </div>
                                <div class="row mb-3">
